#proof/out-static/db_bench --benchmarks=fillseq --num=16777216
...
#proof/out-static/db_bench --benchmarks=readrandom --num=16777216 --reads=125000 --use_existing_db=1 --threads=8 --db=/tmp/data16m-proof/dbbench
#proof/out-static/db_bench --benchmarks=readrandom --num=16777216 --reads=125000 --use_existing_db=1 --threads=8  --db=/tmp/data16m-noproof/dbbench
#proof/out-static/db_bench --benchmarks=readrandom --num=16777216 --reads=125000 --use_existing_db=1 --threads=8  --db=/tmp/data16m-noproof/dbbench --proofdb=/tmp/proof16m/dbbench
#proof/out-static/db_bench --benchmarks=overwrite --num=16777216 --use_existing_db=1 --threads=8 --db=/tmp/data16m-noproof/dbbench --proofdb=/tmp/proof16m/dbbench
#proof/out-static/db_bench --benchmarks=overwrite --num=16777216  --use_existing_db=1 --threads=8 --db=/tmp/data16m-noproof/dbbench
#proof/out-static/db_bench --benchmarks=overwrite --num=16777216 --use_existing_db=1 --threads=8 --db=/tmp/data16m-proof/dbbench
